...
In this project, Chris talked about using the `document.querySelector` method to toggle password field to enable sort of a show/hide switch. The important thing to note is that the variables can be declared in a mixed fashion. Here is my script:
